...
export default function Fundraiser(){
    return(
        <div className="flex flex-col justify-center items-start max-w-[1280px] w-[90%]">
        ...
        <div className="w-full grid grid-cols-3  gap-2 max-xl:grid-cols-2 max-xl:gap-[40px] max-md:grid-cols-1">
           {
