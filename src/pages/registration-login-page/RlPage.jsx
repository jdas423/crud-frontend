...
export default function RlPage({path}) {
    ...
    return(
        <globalContext.Provider value={{num,changeBorder}}>
               <main className="w-full h-full flex items-center" onClick={()=>changeBorder(0)} >
                <section className="left-section lg:w-[40%] w-full h-full pl-[20px] flex flex-col  justify-between items-center  max-lg:bg-bg-img max-lg:bg-cover max-lg:bg-no-repeat max-lg:bg-center bg-[#424769]">
                 <div className="regis-login-changer flex items-start w-full mt-[30px]  justify-center">
                     <div className="w-[80%] max-w-[400px] flex justify-start items-center">
                 ...
                 <div className="regis-login-dis w-full flex justify-center items-center">
                    <Outlet/>
                 </div>
            ...
            <section className=" lg:block hidden right-section w-[60%] h-full bg-bg-img bg-center bg-cover  bg-no-repeat ">
